...
// toLowerCase() will not change the gameName, it will use the copy (pass by value)
console.log(gameName.charAt(7)); //b
console.log(gameName.indexOf("t")); //5

const newString = gameName.substring(0, 5); // 0 includes, 5 not included
// Can't give -ve no. for indexes
// BUT if you give -ve no, then it will not obey your rules and start from 0 index 
...
console.log(url);
//* replace will not update the url, instead generate a new string and log it
